...
const rows = [
  createData('Rushikesh', 'Patil', 'rushikesh.patil@clairvoyantsoft.com', 1234567891, "Active"),
  createData('Sandeep', 'Pawar', 'sandeep.pawar@clairvoyantsoft.com', 2345678912, "Active"),
  createData('Pranali', 'Chaudhari', 'pranali.chaudhari@clairvoyantsoft.com', 3456789123, "Pending"),
];
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell className={classes.tableHead} align="center">Last Name</TableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell className={classes.tableCell} align="center">{row.lname}</TableCell>
              <TableCell className={classes.tableCell}align="center">{row.email}</TableCell>
              <TableCell className={classes.tableCell}align="center">{row.contact}</TableCell>
